...
<% 
    // Controllo se l'utente è autenticato, altrimenti lo reindirizzo alla pagina di login
    if (session.getAttribute("registeredUser") == null) {
        response.sendRedirect("loginPage.jsp");
        return; // Esco dalla pagina per evitare il rendering del form di vendita
    }
%>
